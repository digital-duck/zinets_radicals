...
Evolution of Agricultural Development radicals (Section 2.10). Shows gendered labor (男), field systems (田), seed testing (良), nursery cultivation (甫), and grain plants (禾).
